...
public class Bonus3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bonus3);
    ...
    public void onBackPressed() {
        try {
            Intent intent = new Intent(Bonus3.this, GameLevels.class);
    ...
    public void answer1_L3(View view) {
        switch (view.getId()) {
            case R.id.answer1_L3:
                Dialog dialog;
    ...
    public void answer2_L3(View view) {
        switch (view.getId()) {
            case R.id.answer2_L3:
                Dialog dialog;
                dialog = new Dialog(this);
                dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public void answer3_L3(View view) {
        switch (view.getId()) {
            case R.id.answer3_L3:
                Dialog dialog;
                dialog = new Dialog(this);
                dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                dialog.setContentView(R.layout.bonus_dialog_window_lose);
    ...
    public void answer4_L3(View view) {
        switch (view.getId()) {
            case R.id.answer4_L3:
                Dialog dialog;
                dialog = new Dialog(this);
                dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                dialog.setContentView(R.layout.bonus_dialog_window_lose);
